...
# from ai_security import run_security_analysis
# if RUN_CODE:
...
# main.py - COMPLETE SECURE COMPILER WITH AI
from Lexer import Lexer
from Parser import Parser
from Compiler import Compiler
from AST import Program
...
class SecureCompiler:
    ...
    def _execute_with_monitor(self, module: ir.Module) -> bool:
        ...
        try:
            # Modern llvmlite auto-initializes; keep compatibility with older versions
            try:
